...
def call_alascan(pot_dict, weight_dict, respairs_scores, interface_res, native_score, mode = ['1'], res_list = None):
	...
	if mode == ['1']:
		...
		mutanal_results = mutanal_test(pot_dict, weight_dict, respairs_scores, interface_res, res_list, native_score)
