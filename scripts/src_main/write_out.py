...
def write_out(output_file, out_val, out_val_norm, options, num_interactors, native_score, norm_native_score, z_threshold, respairs, respair_scores, warnings, alscn = None):
	...
	for interface in out_val.keys():
		...
		print "{0:<40s} {1:1s} {2:<6.3f}".format('Normalized Raw Score', ':', norm_native_score[interface])
		...
		print "{0:<40s} {1:1s} {2:<6.3f}".format('Normalized Average Background Score', ':', out_val_norm[interface][1])
		print "{0:<40s} {1:1s} {2:<6.3f}".format('Normalized Standard Deviation', ':', out_val_norm[interface][2])
		print "{0:<40s} {1:1s} {2:<6.3f}".format('Normalized Z-score', ':', out_val_norm[interface][0])
